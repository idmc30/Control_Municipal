             ...
             <tr>   <?php $c=1 ?>
                    <?php  foreach ($ldosmipoi as $metas): ?>
                         ...
                         <tr  id="<?php echo $metas->idmeta; ?>" class="idmetas">
                            ...
                            <td style="border-top: 1px solid rgb(0, 0, 0);"> <?php echo utf8_encode($metas->objetivo).'|'.$cant; ?></td>
                            ...
                            <?php $ltiempos=$poi->listartimpometa($metas->idmeta); ?>
                             ...
                             <?php endif ?>                                                      
                           <td style="border-top: 1px solid rgb(0, 0, 0);"><button  class='btn btn-danger fa  fa fa-pencil' ></button></td>
                           <td style="border-top: 1px solid rgb(0, 0, 0);"><button class='btn btn-danger fa  fa fa-times' ></button></td>
